...
public class InventoryActivityBarcode extends ActionActivity implements OnCheckedChangeListener, OnItemSelectedListener {

    private static final String TAG = InventoryActivityBarcode.class.getSimpleName();
    ...
    public InventoryActivityBarcode() {
        super();

        mView = R.layout.activity_inventory_barcode;
